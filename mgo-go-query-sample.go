...
func main() {
	...
	//if count == 0 {
		err = c.Insert(&Book{"Ale1", "Book1", 55})
		err = c.Insert(&Book{"Ale2", "Book2", 22})
		err = c.Insert(&Book{"Ale3", "Book3", 44})
		err = c.Insert(&Book{"Ale4", "Book4", 11})
		err = c.Insert(&Book{"Ale5", "Book5", 88})
		err = c.Insert(&Book{"Ale6", "Book6", 99})
	//}
